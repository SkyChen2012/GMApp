...
{
	if (LC_MOX_MODE == g_SysConfig.LC_ComMode)
	{
		DpcAddMd(MXMDID_LT_MOX, NULL);
...
LCAMoxThreadFun(void)
{
	...
	g_MsgRecev.dwDestMd		= MXMDID_LT_MOX;
